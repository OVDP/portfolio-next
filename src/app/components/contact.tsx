  ...
  return (
    <>
      <div className="">
        <Alert
          title="Discord"
          text="Feel free to send me a friend request on discord! I'm always open for a chat!"
        />
      </div>
      <section
          ...
          <div className="row mb-5">
            <div className="col-md-8 col-xl-6 text-center mx-auto">
              ...
              <p style={{ textAlign: "center" }}>
                Have a question or other interests? Leave your details, and
          ...
          <div className="row d-flex justify-content-center">
            <div className="col-md-6 col-lg-4 col-xl-4">
              <div className="d-flex flex-column justify-content-center align-items-start h-100">
                <a href="mailto:othnielvandepol@gmail.com">
                  <div className="d-flex align-items-center p-3">
                    ...
                    <div className="px-2">
                      ...
                      <p className="mb-0">othnielvandepol@gmail.com</p>
                    </div>
                  </div>
                </a>
                <a
                  href="https://www.linkedin.com/in/othniel-van-de-pol-6a4933273/"
                  target="_blank"
                >
                  <div className="d-flex align-items-center p-3">
                    <div
                    ...
                    <div className="px-2">
                      ...
                      <p className="mb-0">Othniel van de Pol</p>
                    </div>
                  </div>
                </a>
                <a href="https://github.com/OVDP" target="_blank">
                  <div className="d-flex align-items-center p-3">
                    <div
                      className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon"
                      style={{ background: "#cb1a2c" }}
                ...
                >
                  ...
                  <div className="px-2">
                    <h6 className="mb-0">Discord</h6>
                    <p className="mb-0">OVDP_</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-5 col-xl-4">
              <div>
                <form
                  ...
                  method="post"
                  action="mailto:othnielvandepol@gmail.com"
                >
                  <div className="mb-3">
                    <input
