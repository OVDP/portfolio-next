  ...
  return (
    ...
    >
      <div data-component="experience" id="experience">
        ...
        <Link
          href="https://www.kw1c.nl/opleidingen/software-developer-bol/"
          target="_blank"
        >
          <h1 style={{ fontSize: "18px", margin: "0px 10px 0px 10px" }}>
            Study software developer - KW1C
          </h1>
          <sub style={{ margin: "0px 10px 0px 10px" }}>08/2022 - now</sub>
          <div className="d-lg-flex d-xxl-flex justify-content-lg-center align-items-lg-center align-items-xxl-start">
            <div>
              <p style={{ margin: "0px 10px 0px 10px" }}>
                At KW1C, I am dedicated to becoming a skilled full-stack
                developer capable of creating powerful applications for web,
                mobile, and desktop platforms. Here is a summary on what ive
                learned.
              </p>
              <ul>
                <li>
                  Gained proficiency in programming languages and frameworks
                  including HTML, CSS, JavaScript, PHP, C#, .NET, MySQL,
                  Tailwind CSS, Node.js, Vue.js and Python.
                </li>
                <li>Learned to design with: Figma &amp; Visio</li>
                <li>
                  Enhanced my project management skills using tools such as
                  Trello and Azure DevOps.
                </li>
                <li>
                ...
                <li>
                  Learned to plan, develop, test, debug, and deliver software as
                  a standalone developer or as part of a team.
                </li>
              </ul>
            </div>
        ...
        <Link href="https://www.holdingthedrones.nl/" target="_blank">
          <h1 style={{ fontSize: "18px", margin: "0px 10px 0px 10px" }}>
