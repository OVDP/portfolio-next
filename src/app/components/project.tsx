            ...
            <div className="row">
                <div className="col-md-8 col-xl-6 col-xxl-9 mx-auto p-4" style={{ width: "100%" }}>
                    ...
                    <div>
                        ...
                        </div><sub className="d-lg-flex justify-content-lg-end" style={{textAlign: "right"}}>26/09/2017 - 12/05/2018</sub>
                        <hr className="my-5" style={{ color: "var(--bs-body-bg)", background: "var(--bs-body-bg)" }}/>
                    </div>
                    <div>
                        <div className="d-flex align-items-center align-items-md-start justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center justify-content-xxl-center">
                    ...
                    <div>
                            ...
                            <div className="d-lg-flex justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
                                ...
                                <div>
                                    <div className="d-lg-flex d-xxl-flex justify-content-lg-end align-items-lg-center justify-content-xxl-end align-items-xxl-center" style={{ width: "30rem", textAlign: "right" }}>
                                        <h4 style={{ textAlign: "center", marginRight: "2rem" }}>Unity 2D Platformer</h4>
                                    ...
                                    <p className="d-xxl-flex justify-content-xxl-end" style={{ width: "30rem" }}>For a school project, I created a 2D platformer using the Unity engine. This project allowed me to apply my existing game development knowledge and make progress in learning C#.</p>
                                    <h1 style={{ fontSize: "20px" }}>Skills used:</h1>
                                    <ul>
                                        <li>Unity</li>
                                    </ul>
                        ...
                        </div><sub className="d-lg-flex justify-content-lg-end" style={{textAlign: "right"}}>07/06/2021 - 11/06/2021</sub>
                        <hr className="my-5" style={{ color: "var(--bs-body-bg)", background: "var(--bs-body-bg)" }} />
                    </div>
                    <div>
                        <div className="d-flex align-items-center align-items-md-start justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center justify-content-xxl-center">
                        ...
                        </div><sub>09/09/2022 - 10/09/2022</sub>
                        <hr className="my-5" style={{ color: "var(--bs-body-bg)", background: "var(--bs-body-bg)" }}/>
                    </div>
                    <div>
                        <div className="d-flex align-items-center align-items-md-start justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center justify-content-xxl-center">
                            <div className="d-lg-flex justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
                                ...
                                <div>
                                    <div className="d-lg-flex d-xxl-flex justify-content-lg-end align-items-lg-center justify-content-xxl-end align-items-xxl-center" style={{ width: "30rem", textAlign: "right" }}>
                                        <h4 style={{ textAlign: "center", marginRight: "2rem" }}>Portfolio website</h4>
                        ...
                        </div><sub className="d-lg-flex justify-content-lg-end" style={{textAlign: "right"}}>20/10/2023 - 06/08/2024</sub>
                        <hr className="my-5" style={{ color: "var(--bs-body-bg)", background: "var(--bs-body-bg)" }}/>
                    </div>
                    <div>
                        <div className="d-flex align-items-center align-items-md-start justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center justify-content-xxl-center">
