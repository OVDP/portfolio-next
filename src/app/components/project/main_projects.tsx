        ...
        <div className="d-flex flex-column gap-3">
          {projectsData.slice(0, 3).map((project, index) => (
            <div
              ...
              key={index}
              className="sticky top-50 mx-auto w-100" style={{ maxWidth: '600px' }}
            >
              <div className="d-flex align-items-center justify-content-center rounded shadow" style={{ boxShadow: '0 0 30px rgba(0, 0, 0, 0.3)', transition: 'all 0.5s' }}>
